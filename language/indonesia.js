...
exports.wait = () => {
    return `⏳ Chottomatte Darling~`
}
exports.ok = () => {
    return `✅ Okey Udah Selesai Darling~`
}

exports.err = () => {
    return `Gomenasai Fitur Nya Error`
}
exports.erorLink = () => {
    return `⚠️ Link nya error Darlingg`
}
exports.media = () => {
...
exports.ownerOnly = () => {
    return `❎ Command ini khusus My Darling`
}

exports.doneOwner = () => {
    return `✅  ️Sudah selesai, My Darling ~`
}
...
exports.adminOnly = () => {
    return `Gomenasai Kamu Bukan Admin`
}
...
exports.botNotAdmin = () => {
    return `Tch Bot Bukan Admin Jadi Ngak bisa:(`
}
...
exports.menunya = (salam, pushname, botname) =>{
	return`Hai Darling ${pushname} 👋 selamat ${salam} , 
saya ${botname}, bot ini adalah Beta Multi-Device Whatsapp.
Jangan spam ya:v, 
Gabung Juga Ke Grup Bot! Link: https://chat.whatsapp.com/ED7th5Ie38eBayZEbDPxwY`
}
...
exports.source = () =>{
return`*------「 SC SAKURA BOT:V 」 ------*

Sc Hasil Acak Acak Gw🗿
https://github.com/JakaV3/Alpha-MD11
Sc Ori Cek Aja Yt Zeeoneofc 🗿`
}
